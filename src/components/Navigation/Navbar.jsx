...
const Navbar = () => {
  ...
  return (
    <div className="z-4  fixed top-0 w-full items-start flex justify-between">
      <div className="lg:p-5 p-2">
       ...
       className="bg-black lg:h-16 relative lg:w-[17vw]  w-40 h-12">
        <div ref={navgreenref} className="bg-[#D3FD50] transition-all absolute top-0 h-0 w-full"></div>
        <div className="relative flex  flex-col justify-center items-end lg:gap-2 gap-0.5 lg:px-12  px-8 h-full">
